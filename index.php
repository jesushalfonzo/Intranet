...
<table width="1020" border="0" align="center" cellpadding="0" cellspacing="0" background="img/01_Imagen_1020x816.jpg">
  ...
  <tr>
	...
	<!-- PARA LA VENTANA EMERGENTE INTERTECIAL-->
	<?php 
	include('extras/coneccion.php');
	$link=Conectarse();
	$SQLemergente="SELECT * FROM m_control_ventana WHERE m_control_ventana_activo ='SI'";
	$queryentana=mysql_query($SQLemergente, $link);
	$saleventana=mysql_num_rows($queryentana);
	
	if($saleventana >0){
	$SQldetalleVentana="SELECT * FROM m_ventanaemergente WHERE m_ventanaemergente_home='SI'";
	$querydetalleventana=mysql_query($SQldetalleVentana);
	$rowdatellaventana=mysql_fetch_array($querydetalleventana);
	$m_ventanaemergente_imagen=$rowdatellaventana["m_ventanaemergente_imagen"];
	$m_ventanaemergente_enlace=$rowdatellaventana["m_ventanaemergente_enlace"];
	$m_ventanaemergente_tipo=$rowdatellaventana["m_ventanaemergente_tipo"];
	 ?>
	<div style="position:absolute; top:120px; z-index:1005;" id="publicidad" align="center">
  ...
  <tr align="center">
    <td  valign="top"><table width="692" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <th width="164" align="right" valign="top" scope="col"><img src="img/bt_cerrar.jpg" width="146" height="30" border="0" usemap="#Map" /></th>
          <th width="528" valign="top" scope="col">&nbsp;</th>
        </tr>
        <tr>
          <th colspan="2" valign="top" scope="col">
		          <?php  if ($m_ventanaemergente_tipo=="swf"){?>
		          <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="656" height="480">
		            <param name="movie" value="multimedia/home/<?php echo $m_ventanaemergente_imagen; ?>" />
		            ...
		            <!--[if !IE]>-->
		            <object type="application/x-shockwave-flash" data="multimedia/home/<?php echo $m_ventanaemergente_imagen; ?>" width="656" height="480">
		              <!--<![endif]-->
		              <param name="quality" value="high" />
		              <param name="wmode" value="opaque" />
		              <param name="swfversion" value="6.0.65.0" />
		          ...
		          <?php } else { ?>
		          <?php if($m_ventanaemergente_enlace!=""){  ?>
		          <a href="dsddd.php" target="_blank">
		            <?php } ?>
		            <img src="multimedia/home/<?php echo $m_ventanaemergente_imagen; ?>"  width="656" height="480" border="0" />
		            <?php if($m_ventanaemergente_enlace!=""){  ?>
		            </a>
		          <?php } ?>		          <?php } ?>		          </th>
        </tr>
