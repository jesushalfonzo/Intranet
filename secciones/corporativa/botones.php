...
<table width="1020" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <?php/*<td width="128" height="26" class="<?php if($fichero=="/encuesta/index.php"){ echo "Arial_12_bold_azul";} else { echo "Arial_12_bold_negro"; } ?>"><a href="/secciones/corporativa/encuesta" class="<?php if($fichero=="/encuesta/index.php"){ echo "Arial_12_bold_azul";} else { echo "Arial_12_bold_negro"; } ?>" style="text-decoration:none;">Encuesta</a></td>
    <td width="1" height="26"><img src="../../img/28_linea_1x11.jpg" width="1" height="11" /></td>*/?>
