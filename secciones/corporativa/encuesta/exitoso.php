...
if($_GET['error']=1){echo "<script language='JavaScript'>alert('Usted Solo puede votar una vez');</script>";}
 ?>
...
<table width="1020" border="0" align="center" cellpadding="0" cellspacing="0" background="../../../img/01_Imagen_01_1020x1100.jpg">
  ...
  <tr>
   ...
   <tr>
    ...
    <div class="Hora_Alto" style="margin-top:180px;">Gracias por votar</div>
    <div class="Arial_18_blanco_bold" style="text-align:center; margin-top:20px;">El viernes 12/09/2014 descubriremos juntos qui&eacute;nes son los ganadores</div>
	<div  style="margin-top:50px; margin-left:480px;"><a href="index.php" style="text-decoration:none;" class="button blue">Volver</a></div>
    </td>
  </tr>
  <tr>
