...
<table width="1020" border="0" align="center" cellpadding="0" cellspacing="0" background="../../img/01_Imagen_01_1020x1100.jpg">
  ...
  <tr>
	...
	if (!isset($_GET['ckl']) or ($_GET["ckl"]=='')){
	 ...
	 $noticiatira = "SELECT  * FROM noticia, home_principal WHERE id=id_nota AND id_home='1'";
	 }
	 else{
	 $idnota=$_GET["ckl"];
	 $noticiatira = "SELECT  * FROM noticia WHERE id='$idnota'";
	 }
...
<div style="width:900px; padding-left:20px;  margin-top:10px; padding-right:10px;" class="Gris_Oscuro_13px_Regular ScrollX">
  <table width="325" border="0" align="right" cellpadding="0" cellspacing="0" class="bordes_todos" style="margin-left:15px; margin-bottom:15px;">
    <tr>
	  ...
	  <img src="../../imagenes/<? echo"$imagen"; ?>" width="350" height="300" />
	 </span></div></td>
      </tr>
  </table>
  <span class="Arial_22_bold_negro"><strong><? echo"$titulo"; ?></strong>
  </p>
  </span>
