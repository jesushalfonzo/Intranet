...
$actualizar="INSERT INTO t_documentos_juridicos VALUES(Null, '$idpeticion', '$titulo', '$nombre_new', '$fechacompleta', '2', '')";
...
<tr><td colspan='3'>&nbsp;</td></tr>
 <tr>
   <td><div style='font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; margin-left:5px;'>El usuario: . ".$nombre_completo.", ha enviado un total  de ".$tot." archivo".$letra.", para ver dicho".$letra." documento".$letra." acceda a la aplicaci&oacute;n y revise la solicitud. </div></td>
 </tr>
 

<tr>
  <td colspan='3'><div style='font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; margin-left:5px; margin-top:15px; margin-bottom:15px;'>TeleSUR</div>
	</td>
</tr><tr>
...
$htmlgente="<!DOCTYPE html_usuario PUBLIC '-//W3C//DTD Xhtml_usuario 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml_usuario1/DTD/xhtml_usuario1-transitional.dtd'>
<html_usuario xmlns='http://www.w3.org/1999/xhtml_usuario'>
<head>
<meta http-equiv='Content-Type' content='text/html_usuario; charset=iso-8859-1' />
<title>Untitled Document</title>
...
<tr><td colspan='3'>&nbsp;</td></tr>
 <tr>
   <td><div style='font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; margin-left:5px;'>Sr(a). ".$nombre_completo.", el Departamento de Consultoría Jurídica le informa que ha recibido satisfactoriamente un total de ".$tot." archivo".$letra.". </div></td>
 </tr>
...
require_once('htmlMimeMail5/htmlMimeMail5.php');
 ...
 $mail->send(array('consultoriajuridica@telesurtv.net'), 'smtp');
 ...
 //PARA EL USUARIO
   ...
   //Establecemos el asunto
    $subjectvar2="Asesoría  Jurídica - Archivos recibidos";
	//$subjectvar=htmlentities($texto,ENT_QUOTES,"UTF-8");
    ...
    $mail2->setHtml($htmlgente);
    
   
    $mail2->setSMTPParams('correo.telesurtv.net', 25, null, true,'jalfonzo@telesurtv.net', '*webjesus*');

 $mail2->send(array($correo), 'smtp');

echo "<script language='JavaScript'>parent.location.href='listado.php';</script>";
