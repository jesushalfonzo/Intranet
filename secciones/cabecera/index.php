...
<table width="1020" height="190" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="258" height="52" class="dia_medio"><div style="width:258px; margin-bottom:28px;"><?php echo date("d", time()); ?> <?php echo MesLetras(date("m", time()));?> <?php echo date("Y", time()); ?></div></td>
        ...
        <td width="252"  class="web_alto" valign="top"><table width="252" height="150" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="252" height="108">
            <table width="252" height="108" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
...
if($masterSeccio!=""){
 ?>
	<a href="<?php echo $serveractual; ?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('inicio','','<?php echo $serveractual; ?>/img/2_inicio_122x106.png',1)"><img src="<?php echo $serveractual; ?>/img/1_inicio_122x106.png" name="inicio" width="122" height="106" border="0" id="inicio" /></a>
	<?php } else {?>
	<img src="<?php echo $serveractual; ?>/img/spc.gif" name="inicio" width="122" height="106" border="0" id="inicio" />
	
	<?php } ?>
	</td>
    <td><a href="<?php echo $serveractual; ?>/mapa.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('mapa','','<?php echo $serveractual; ?>/img/2_mapa_128x106.png',1)"><img src="<?php echo $serveractual; ?>/img/1_mapa_128x106.png" name="mapa" width="128" height="106" border="0" id="mapa" /></a></td>
  </tr>
</table>
            </td>
          </tr>
          <tr>
            <td  class="web_alto"><div style="width:250px; margin-top:8px; text-align: center; margin-bottom:5px;" >www.telesurtv.net</div></td>
          </tr>
        </table></td>
