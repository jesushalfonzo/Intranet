...
Hoy nos unimos en una sola voz para transmitirle este mensaje de amor y solidaridad:</p>
   ...
   <tr>
    <td width="1020" colspan="5"><div class="Arial_13_Vinotinto_Bold" style="margin-left:70px;">Mensajes</div></td>
  </tr>
</table>
</td>
  </tr>
  ...
  <tr>
    <td height="247"  valign="top"><div style="margin-left:60px;"><table width="918" border="0" cellpadding="0" cellspacing="0">
      <tr>
        
        <td valign="top" width="56%">
		<div style="width:890px; padding-right:15px;" class="ScrollX">
		<?php 
		...
		<div style="width:850px; background:#FFFFFF; padding-left:5px; padding-right:5px;" align="left">
