...
$masterSeccio="RRHH";
 ?>
		...
		<?php
	$SQL="SELECT m_rhh_info_titulo, m_rhh_info_sumario, m_rhh_info_id, m_rhh_info_fecha, m_rhh_info_contenido FROM m_rhh_info WHERE m_rhh_info_aprobada='SI' AND m_rhh_info_categoria='operativos' ORDER BY m_rhh_info_id DESC";
  ...
  <tr>
    ...
    <table width="593" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="87" height="22" class="Arial_12_blanco_Bold"><div style="margin-left:10px; margin-right:10px;" >Operativos</div></td>
        <td width="1" height="22"><img src="../../img/28_linea_1x11.jpg" width="1" height="11" /></td>
