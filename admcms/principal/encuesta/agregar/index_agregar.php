...
<title>Prueba insertar encuesta</title>
...
<body>
<form name="form1" method="post" action="agregar_agregar.php" onSubmit="return validar();" enctype="multipart/form-data">
...
<tr>
  ...
  Autor: <input type="text" name="nombre[]" size="30" />
  <br />
  Titulo: 
...
<tr><td colspan="2" align="center"><input type="submit" name="Submit" value="Guardar" class="pequeno">agregar</td></tr>
</table>
