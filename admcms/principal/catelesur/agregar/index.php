    ...
    if (document.myform.titulo_nota.value.length==0){
       ...
       document.myform.titulo_nota.focus()
	    ...
	    return false;
	       ...
	       if (document.myform.foto_0_nota.value.length==0){
       alert("Debe cargar una foto")
       document.myform.foto_0_nota.focus()
...
document.getElementById("leyenda_0_nota").value='';
return false;
}
}
</script>
  ...
  <table width="515" border="0" cellspacing="0" cellpadding="3">
    <tr>
      <td class="texto"><span class="etiquetas">T&iacute;tulo</span><br />
        <input name="titulo_nota" type="text" id="titulo_nota" size="50" /></td>
    </tr>
	<tr><td><img src="../../../img/spc.gif" width="10" height="10" /></td>
    </tr>
	<tr><td valign="top"><textarea cols="50" id="editor1" name="editor1" rows="4" class="cajaTexto" ></textarea>
<script type="text/javascript">
			//<![CDATA[
CKEDITOR.replace( 'editor1',
  ...
  <table width="500" border="0" cellspacing="0" cellpadding="3">
	...
	<tr>
      <td class="texto"><span class="etiquetas">Foto (350 X 300) </span><br />
