...
<form name="myform" method="post" enctype="multipart/form-data" action="modificar.php" onsubmit="return submitForm();">
  <table width="515" border="0" cellspacing="0" cellpadding="3">
    ...
    <tr>
      <td class="texto"><input name="id_busca" type="hidden" value="<? echo"$idperfil"; ?>" /></td>
    </tr>
	<td class="texto"><span class="etiquetas">Nombre</span>
	<input name="titulo" type="text" value="<? echo"$perfil_titulo"; ?>" size="70"/></td>
	</tr>
	...
	<tr><td><img src="../../../../img/spc.gif" width="10" height="10" /></td></tr>
	<tr>
	  <td><span class="etiquetas">Foto pagina principal: (92 x 92) / </span><a href="<? if ($perfil_fotoprincipal!='') {echo "../../../../../imagenes/perfiles/$perfil_fotoprincipal";} ?>">
	...
	<tr><td><img src="../../../../img/spc.gif" width="10" height="10" /></td></tr>
	<tr><td><span class="etiquetas">Aprobar</span>
	<input name="status" type="checkbox"  value="A" <? if ($estatus=='A') { echo"checked"; }  ?>  />
	</td></tr>
	<tr><td><img src="../../../../img/spc.gif" width="10" height="10" /></td></tr>
	<tr><td align="center">
	  <input name="id_busca" type="hidden" value="<? echo"$idperfil"; ?>" />
