...
$alinea=$_POST["aling"];
$foto_leyenda=$_POST["foto_leyenda"];
if ($alinea=="Derecha"){
$alinear="right";
}
if($alinea=="Izquierda"){
...
$actualizar="update fotos_perfiles set palabra_1='$palabra_1', palabra_2='$palabra_2', palabra_3='$palabra_3', foto_leyenda='$foto_leyenda', alineacion='$alinear' where id_fotos='$idfotos'"; 
 
//$tirasql="INSERT INTO fotos_perfiles (id_perfil, palabra_1, palabra_2, palabra_3, alineacion) VALUES (\"$idperfil\", \"$palabra_1\", \"$palabra_2\",\"$palabra_3\",\"$alinear\")";
//echo"$tirasql";
   $link=Conectarse();   
...
$actualizar="update fotos_perfiles set ruta_imagen='$nombre_new' where id_fotos='$idfotos'"; 
echo"$actualizar";
$resultado=mysql_query($actualizar,$link); 
