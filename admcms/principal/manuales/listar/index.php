...
<? 
	   $link=Conectarse();   
	   $tirasql="select * from manuales order by id DESC";
...
<table width="515" border="0" cellpadding="3" cellspacing="0" class="texto">
    ...
    <td bgcolor="#FFFFFF" class="etiquetas"><? echo "$titulo"; ?>  </td>
      <td align="right" bgcolor="#FFFFFF" class="etiquetas"><table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td> 
<input name="editar" type="submit" class="pequeno" id="editar" value="Editar"  onClick="TomarValor('<? echo "$id";?>','Editar')" />
         </td>
          <td>
<input name="borrar" type="submit" class="pequeno" id="borrar" value="Borrar"  onClick="TomarValor('<? echo "$id";?>','Eliminar')" />
</td>
        </tr>
      </table>
</td>
