...
$sumario_nota=$_POST["sumario_nota"];
...
$tirasql="INSERT INTO noticia (titulo, contenido , sumario, fecha, leyenda, autor) VALUES (\"$titulo_nota\", \"$rte1\", \"$sumario_nota\",\"$fecha_nota\",\"$leyenda_0_nota\",\"$autor_nota\")";
...
$nombre_origfoto_0_nota = $HTTP_POST_FILES['foto_0_nota']['name'];

if ($nombre_origfoto_0_nota!='')
{
$nombre_original = $HTTP_POST_FILES['foto_0_nota']['name'];
$carpeta = '../../../../imagenes/';
$numerito=rand(0, 1115) . '.jpg';
$nombre_new = 'INF'.$lastshit.'_'.$numerito;
$nombre_temporal = 'temporal.jpg';

    if (move_uploaded_file($HTTP_POST_FILES['foto_0_nota']['tmp_name'],$carpeta.$nombre_temporal)){
