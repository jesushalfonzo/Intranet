<? include ('../../../extras/connect.php');
   ...
   $tirasql="select id, contenido, titulo,sumario, fecha,imagen  from noticia order by id desc ";
...
<table width="715" border="0" cellpadding="3" cellspacing="1" bgcolor="#404040" class="texto">
  ...
  <tr>
    ...
    <td width="50" align="center" bgcolor="#D4D0C8"><input name="accion" type="submit" class="pequeno" value="Editar" onClick="TomarValor('<? echo " $idnoticia";?>','Editar')"/></td>
