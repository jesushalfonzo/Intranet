...
<form name="myform" method="post" enctype="multipart/form-data" action="editarnoticia.php" onsubmit="return submitForm();">
  <table width="515" border="0" cellspacing="0" cellpadding="3">
	...
	<tr><td><img src="../../../../img/spc.gif" width="10" height="10" /></td></tr>
	<tr>
      <td class="texto"><span class="etiquetas">Imágen&nbsp; (280 x 175)</span> /
	...
	<td align="center"><input type="submit" name="boton" value="Actualizar" /><? if($aprobado!='SI'){ ?><input type="submit" style="margin-left:+10px;" name="boton" value="Actualizar/Aprobar" /> <? } ?></td></tr>
	</table>
</form>
	</body>
	</html>
