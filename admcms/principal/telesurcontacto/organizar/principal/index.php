<? include ('../../../../extras/connect.php');
	  $link=Conectarse();
	  $soulsismine="select id, contenido, titulo,sumario, fecha,imagen, aprobado  from noticia where aprobado='SI' order by id desc"
      ...
      <dd>Sustituir por: <br />
		...
		<? 
			  $result = mysql_query($soulsismine,$link);
				...
				//$m_noticia_fechacreacion=$m_noticia_fechacreacion.'00:00:00';
				//$m_noticia_fechacreacion=strtotime($m_noticia_fechacreacion);
				//$fecha = date("d-m-Y H:i", $m_noticia_fechacreacion);
				$tituloyfecha= $m_noticia_titulo. " &iota;    " .	$m_noticia_fechacreacion;
