...
if($fechadesde==''){
$fechadesdeFormat=date('Y-m-d', time());
$desdewrite=date('d/m/Y', time());
}
else{
$sep=explode('/', $fechadesde);
$dia=$sep[0];
$mes=$sep[1];
$year=$sep[2];
$fechadesdeFormat=$year."-".$mes."-".$dia;
$desdewrite=$dia."/".$mes."/".$year;
}


if($fechahasta==''){
$fechaHastaFormat=date('Y-m-d', time());
$hastawrite=date('d/m/Y', time());
}
else{
$sepa=explode('/', $fechahasta);
$dia2=$sepa[0];
$mes2=$sepa[1];
$year2=$sepa[2];
$fechaHastaFormat=$year2."-".$mes2."-".$dia2;
$hastawrite=$dia2."/".$mes2."/".$year2;
}

$SQL="SELECT *FROM m_aplicativo_cjuridica WHERE date(m_aplicativo_cjuridica_fechasolicitud)>='$fechadesdeFormat' AND date(m_aplicativo_cjuridica_fechasolicitud)<='$fechaHastaFormat' ORDER BY m_aplicativo_cjuridica_clasificacion ASC ";
...
<script language="javascript" src="cal3.js">
    ...
    <td><table width="796" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="2"><table cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td width="105"><div align="center"><img src="../img/estadisticas.gif" width="34" height="34" border="0" title="Estadísticas" /></div></td>
      ...
      <tr>
        ...
        <td width="789" valign="top" align="center"><form name="formulario" id="formulario" action="estadisticas.php" method="post">
          <table width="783" border="1" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center">
            <tr bgcolor="#000000">
              <td><div align="center" class="Titulos">Peticiones de Asistencia jur&iacute;dica | Seleccione rango de fecha </div></td>
            </tr>
            <tr>
              <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
                <tr bgcolor="#000000" style="border:none;">
                  <td width="93" bgcolor="#FFFFFF" ><div align="center" class="Titulos"><span class="texto_pregunta_TuZona">Desde:</span></div></td>
                  <td width="68" align="left" bgcolor="#FFFFFF"><input type="text" align="texttop" name="fechadesde" class="pequeno" value="<?php echo $desdewrite; ?>"  size="10"  style="text-align:center;" /></td>
                  <td width="32" bgcolor="#FFFFFF" class="texto_pregunta_TuZona" ><a href="javascript:showCal('calendario')"><img src="../img/app_date.png" width="19" height="19" border="0" align="texttop" /></a></td>
                  <td width="56" bgcolor="#FFFFFF" class="texto_pregunta_TuZona" >Hasta:</td>
                  <td width="77" bgcolor="#FFFFFF" ><input type="text" align="texttop" name="fechahasta" class="pequeno" value="<?php echo $hastawrite; ?>"  size="10"  style="text-align:center;" onchange="enviar_formulario();" /></td>
                  <td width="35" bgcolor="#FFFFFF" ><a href="javascript:showCal('calendariohasta')"><img src="../img/app_date.png" width="19" height="19" hspace="4" border="0" align="texttop" /></a>&nbsp;</td>
                  <td width="418" bgcolor="#FFFFFF" ><input type="image" border="1" name="button" value="guardar" width="20" height="20" style="color: #fff; background-image:url(../img/shade.png); padding: 5px; background-position: bottom; font-weight:bold;"  src="../img/avances5.png" alt="Guardar... " title="Recargar... " /></td>
                </tr>
              </table></td>
            </tr>
     
            <tr bgcolor="#FFFFFF">
              <td align="center"><span class="titulo_entrevista"><img src="../img/spacer.gif" width="100" height="20" /></span></td>
            </tr>
			
			
			
			<tr><td valign="top"><table width="777" border="1" cellpadding="0" cellspacing="0">
					<tr bgcolor="#000000">
...
<?php echo $fechaASIGPrint; ?>	
	...
	?>
	<img src="../img/<?php if($m_aplicativo_cjuridica_estatus=='D'){ echo'rojo.png'; } if ($m_aplicativo_cjuridica_estatus =='B'){  echo'amarillo.png'; } if ($m_aplicativo_cjuridica_estatus =='A'){  echo'verde.png'; } ?>"
	 width="11" height="11" border="0" title="<?php if($m_aplicativo_cjuridica_estatus=='D'){ echo'En Espera'; } if ($m_aplicativo_cjuridica_estatus =='B'){  echo'En Proceso'; } if ($m_aplicativo_cjuridica_estatus =='A'){  echo'Atendida'; } ?>"></div></td>
	<td><div align="center"><a href="ver.php?clx=<? echo"$m_aplicativo_cjuridica_id"; ?>"><img src="../img/lupaver_1.png" width="30" height="30" border="0" title="Ver Solicitud" /></a></div></td>
	  ...
	  <tr bgcolor="#000000">
        <td colspan="7" align="center" bgcolor="#FFFFFF"><img src="../img/spacer.gif" height="15" width="80" /></td>
      </tr>
      <tr bgcolor="#000000">
        <td colspan="7" align="center" bgcolor="#FFFFFF"><img src="librerias/jpgraph-3.5.0b1/1.php?desde=<?php echo $fechadesdeFormat; ?>&hasta=<?php echo $fechaHastaFormat; ?>" /></td>
      </tr>
	  <tr bgcolor="#000000">
        <td colspan="7" align="center" bgcolor="#FFFFFF"><img src="../img/spacer.gif" height="15" width="80" /></td>
      </tr>
      ...
      <tr bgcolor="#000000">
        <td colspan="7" align="center" bgcolor="#FFFFFF"><img src="librerias/jpgraph-3.5.0b1/2.php?desde=<?php echo $fechadesdeFormat; ?>&hasta=<?php echo $fechaHastaFormat; ?>" /></td>
      </tr>
	  <tr bgcolor="#000000">
        <td colspan="7" align="center" bgcolor="#FFFFFF"><img src="../img/spacer.gif" height="15" width="80" /></td>
      </tr>
