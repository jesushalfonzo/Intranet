...
$desde=$_GET["desde"];
$hasta=$_GET["hasta"];
$talfi="Solicitudes de Consultoria Juridica (Atenciones)";
include('../../../../../extras/coneccion.php');
$link=Conectarse();

$SQL="SELECT COUNT(*) AS Num, m_aplicativo_cjuridica_clasificacion AS Clasificacion, m_aplicativo_cjuridica_estatus FROM m_aplicativo_cjuridica WHERE date(m_aplicativo_cjuridica_fechasolicitud)>='$desde' AND date(m_aplicativo_cjuridica_fechasolicitud)<='$hasta' GROUP BY m_aplicativo_cjuridica_estatus ASC";
...
$categoria=$row['m_aplicativo_cjuridica_estatus'];
if($categoria=='A'){
$categoria='Atendidas';
}
else{
