...
if (isset($_SESSION["c0nsult0r1aJur1d1c4"])){ $variable=$_SESSION["c0nsult0r1aJur1d1c4"]; } else{ $variable=""; }
if ($variable == '4dm1n1str4jur1d1c4s'){
...
<title>TeleSUR - Intranet - Asistencia Jurídica </title>
...
<table width="798" cellspacing="0" cellpadding="0" bgcolor="#E7E8E9" align="center">
 <? include('../../cabecera.php'); ?>
  ...
  <tr>
	...
	<tr>
	  <td colspan="2" align="center" class="Titulo_Rojo"><div style="margin-bottom:15px; margin-top:5px;">ACCESO RESTRINGIDO | IDENTIFIQUESE </div></td>
	</tr>
      <tr>
