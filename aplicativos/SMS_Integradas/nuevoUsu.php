...
<body>
<form method="post" name="formulario_inicio" id="formulario_inicio" action="guardarUsu.php" onsubmit=" return validar_envia();">
<br />
...
<table width="406" border="0" align="center">
  ...
  <tr>  	 
	...
	<td><input name="telefono" type="text" id="telefono" size="30" maxlength="11" onKeypress="return isNumberKey(event,this)"></td>
    </tr> 
	<tr><td colspan="2"><div align="center">
	  <input type="image" border="1" name="button" value="guardar" width="30" height="30" style="color: #fff; background-image:url(../img/shade.png); padding: 5px; background-position: bottom; font-weight:bold;"  src="imagenes/guradar_grande2.png" alt="Guardar... " title="Guardar... " />
	  </div></td></tr>
</table>
  <br />
