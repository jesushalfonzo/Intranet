 ...
 <? include('../cabecera.php'); ?>
  ...
  <tr>
	...
	<td width="686"><div class="texto_Gris" align="right" style="margin-right:30px; margin-bottom:5px;"><a href="estadisticas.php"></a>Usuario:<span class="Numeros_rojo"><? echo $usuarioadm; ?></span> / <a href="cerrar.php" style="text-decoration:none;"> Cerrar sesión</a></div></td>
          ...
          <tr>
            <td width="779" height="23" background="../../images/barra_larga.gif" class="Titulos">Comunicaciones Integradas | Enviar Programaci&oacute;n </td>
          </tr>
          <tr>
            <td bgcolor="#FFFFFF" valign="top">
			 <form action="enviar2.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validando();">
			...
			<tr><td height="25" colspan="2" align="center"><input type="file" name="archivo" id="archivo" /></td></tr>
			<tr>
				</tr>
