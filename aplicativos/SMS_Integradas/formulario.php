  ...
  <tr>
	...
	<td width="686"><div class="texto_Gris" align="right" style="margin-right:30px; margin-bottom:5px;"><a href="estadisticas.php"></a>Usuario:<span class="Numeros_rojo"><? echo $usuarioadm; ?></span> / <a href="cerrar.php" style="text-decoration:none;"> Cerrar sesión</a></div></td>
          ...
          <tr>
			...
			<tr><td height="25" colspan="2" align="center"><div class="texto_pregunta_TuZona" id='msj' style='margin-bottom:10px; width:320px; margin-left:0px; margin-top:20px; font-family:Arial, Helvetica, sans-serif; font-size:12px;'>135 carácteres disponibles para alcanzar el límite.</div></td></tr>
			<tr>
				</tr>
